...
dictionary ={'A': 1, 'E': 1, 'I': 1, 'O': 1, 'U': 1, 'L': 1, 'N': 1, 'S': 1, 'T': 1, 'R': 1,
             ...
             'а': 1, 'в': 1, 'е': 1, 'и': 1, 'н': 1, 'о': 1, 'р': 1, 'с': 1, 'т': 1, 'д': 2,
             'К': 2, 'Л': 2, 'М': 2, 'П': 2, 'У': 2, 'Б': 3, 'Г': 3, 'Ё': 3, 'Ь': 3, 'Я': 3,
             'к': 2, 'л': 2, 'м': 2, 'п': 2, 'у': 2, 'б': 3, 'г': 3, 'ё': 3, 'ь': 3, 'я': 3,
             'Й': 4, 'Ы': 4, 'Ж': 5, 'З': 5, 'Х': 5, 'Ц': 5, 'Ч': 5, 'Ш': 8, 'Э': 8, 'Ю': 8, 
             'й': 4, 'ы': 4, 'ж': 5, 'з': 5, 'х': 5, 'ц': 5, 'ч': 5, 'ш': 8, 'э': 8, 'Ю': 8,
             'Ф': 10, 'Щ': 10, 'Ъ':10, 'ф': 10, 'щ': 10, 'ъ':10}
print("Введите слово: ")
word = str(input())
cost = 0

for i in word:
    cost = cost + dictionary[i]

print(f"Стоимость введённного слова: {cost} очков")